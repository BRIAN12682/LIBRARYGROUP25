...
class Students(models.Model):
    ...
    def __str__(self):
        return str(f"{self.first_name} - {self.student_id}")
...
class IssueBook(models.Model):
    book_to = models.ForeignKey(Request,
                                on_delete=models.CASCADE, related_name="+")
    issue_book = models.ForeignKey(Request, on_delete=models.CASCADE, related_name="+")
    ...
    def __str__(self):
        return str(f"{self.issue_book}, {self.book_to}, {self.status}")
